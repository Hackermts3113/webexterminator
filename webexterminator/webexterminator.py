...
def Informationgathering():
  try:
    ...
    print(Fore.LIGHTBLUE_EX+"*****************************")
    time.sleep(0.1)
    print(Fore.LIGHTCYAN_EX+"[7] Bypass CloudFlare")
    time.sleep(0.1)
    print(Fore.LIGHTBLUE_EX+"*****************************")
    time.sleep(0.1)
...
def cloudflare():
    ...
    print(Fore.LIGHTGREEN_EX+"[!] pleas enter Website address")
    init()
    print(Fore.RED+" _____"+Fore.GREEN+"["+Fore.WHITE+"webexterminator"+Fore.LIGHTBLUE_EX+"$HOME"+Fore.LIGHTCYAN_EX+"#Information Gathering"+Fore.LIGHTYELLOW_EX+"/Bypass CloudFlare"+Fore.GREEN+"]"+Fore.RED)
    site = input("|_______.::[ ")
...
uat-online
  """).split("\n")
    import socket
    print(Fore.WHITE+"pleas wait ... \n cheking 10000 subdomin")
    
    try:
     for s in sub:
      try:
       ips = socket.gethostbyname(str(s)+site)
       print("[!!] Bypass [ " + str(ips) +" ]   || "+ str(s)+"."+site )
      except:
        pass 
    except:
      home()
